<?php 
		...
		if(isset($_POST['create'])){
			extract($_POST);
			if(!empty($site_name))
			{  $insert=array('site_name'=>$site_name,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($site_name))
			{$updatearray=array("id"=>$id);$upd2=array('site_name'=>$site_name,'date'=>date('Y-m-d'),'status'=>1);
